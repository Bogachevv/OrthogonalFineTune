'''
This module defines an enumeration of categories and subcategories of objects represented in the MMLU dataset.
'''

__all__ = ['subcategories', 'categories', 'subcat_to_cat']
